...
#		line.gsub!(/ls/, '')
	...
	def read_degraded
		@degraded_lines = []
		file = File.open('/Users/wwwjscom/Downloads/confusion_track/degrade5/01/FR940104.0')
...
force_skip_origin	= [658,664,720,721,735]
force_skip_degraded = [311,541,845,1961]

t = TRECOCRParser.new(2040, force_skip_degraded, force_skip_origin)
t.main
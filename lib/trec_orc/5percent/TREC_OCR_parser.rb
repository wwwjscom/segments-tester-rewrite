...
#		line.gsub!(/ls/, '')
	...
	def read_source
		file = File.open('/Users/wwwjscom/Downloads/confusion_track/original/01/fr940104.2')
		i = 0
		@doc_lines = []
	...
	def read_degraded
		@degraded_lines = []
		file = File.open('/Users/wwwjscom/Downloads/confusion_track/degrade5/01/FR940104.2')
...
force_skip_origin	= [1144,2927,5551,5578]
force_skip_degraded = [158,230,278,659,895,910,925,938,1355,1918,2117,2684,4087,4102,4367,4392,4407,4412,4416,4422,4611,4634,4685,5019,5195,5202]
